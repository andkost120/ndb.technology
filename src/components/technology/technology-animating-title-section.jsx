...
/* -------------------------------------------------------------------------- */
export default function TechnologyAnimatingTitleSection() {
    /* -------------------------------------------------------------------------- */
    /*                                 Containers                                 */
    /* -------------------------------------------------------------------------- */
    const title = useRef()
    ...
    return (
        <div>
            <div className="technology-title-section d-lg-block d-none">
                <div ref={title} className="text-center font-weight-bold display-1">
                    <span className="word word-1">NDB</span>{" "}
                    <span className="word word-2">Cell</span>
                </div>
                <div ref={subTitle} className="text-center text-uppercase fw-500 mt-4 fs-20-px">
                    <span className="word word-1">self-</span>
                    <span className="word word-2">charging</span>
                </div>
            </div>
            <div className="technology-title-section d-lg-none d-block py-5 my-5">
